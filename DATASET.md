...
Create a new mixin config file `config/MemLoTrack/_mixin/my_dataset_train.yaml`:

```yaml
# config/MemLoTrack/_mixin/my_dataset_train.yaml
...
```shell
./run.sh MemLoTrack dinov2 --mixin my_dataset_train --output_dir /path/to/output
```
...
Create a new mixin config file `config/MemLoTrack/_mixin/my_dataset_test.yaml`:

```yaml
# config/MemLoTrack/_mixin/my_dataset_test.yaml
...
```shell
./run.sh MemLoTrack dinov2 --mixin my_dataset_test --mixin evaluation --weight_path /path/to/weight.bin --output_dir /path/to/output
```

Train with the default setting and evaluate with the new dataset:
```shell
./run.sh MemLoTrack dinov2 --mixin my_dataset_test --output_dir /path/to/output
```

Train and evaluate with the new dataset:
```shell
./run.sh MemLoTrack dinov2 --mixin my_dataset_train --mixin my_dataset_test --output_dir /path/to/output
```
